...
class _InputChipAppiState extends State<InputChipAppi> {
  ...
  Widget textTield({required textFieldStyle}) {
  ...
  Widget dropdownField({required textFieldStyle}) {
    final updatedTextFieldStyle = textFieldStyle.copyWith(
      validator: switchValidator,
    );
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        widget.dropdownList == null ? textTield(textFieldStyle: widget.textFieldStyle) : dropdownField(textFieldStyle: widget.textFieldStyle),
        const SizedBox(
          height: 5,
        ),
